...
export const Modal = ({ closeModal, onSubmit, defaultValue }) => {
  ...
  return (
    ...
    >
      ...
      <div className="modal rounded-3xl-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark overflow-auto">
      ...
      >&times;</strong>
        ...
        <div className="grid grid-cols-3 gap-5 justify-normal">
          <div className="form-group w-full col-span-3">
            ...
            <input className="w-full rounded-3xl border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
          ...
          <div className="form-group ">
            ...
            <div className="relative z-20 w-full rounded-3xl border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
                  <span className="m-1.5 flex items-center justify-center rounded-3xl border-[.5px] border-stroke bg-gray py-1.5 px-2.5 text-sm font-medium dark:border-strokedark dark:bg-white/30">
                      {formState.para}
          ...
          <div className="form-group">
            ...
            <div className="relative z-20 w-full rounded-3xl border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
                  <span className={`${formState.type==0?"bg-[#04b20c]":formState.type==1?"bg-[#eab90f]":"bg-[#e13f32]"} m-1.5 flex items-center justify-center rounded-3xl border-[.5px] border-stroke py-1.5 px-2.5 text-white font-medium dark:border-strokedark`}>
          ...
          <br></br>
          <button className="btn flex justify-center rounded-3xl bg-primary py-2 px-6 font-medium text-gray hover:shadow-1"
